...
4. **UI 组件详解**
   - 项目中的自定义组件（View/ViewGroup/Composable）完整清单是什么？请提供每个组件的类名、相对路径、行号范围和核心方法位置，并简要说明每个组件的功能或职责。【初级 | What】
...
6. **Jetpack Compose（如使用）**
   - 项目中 Compose 的核心可组合函数有哪些？请列出文件路径、行号范围，并说明每个函数的功能或职责。 【初级 | What】
   - Compose 状态管理是如何实现的？请提供状态定义和状态提升的具体代码位置，并简要说明代码片段中状态变量的功能或职责。 【中级 | How】
